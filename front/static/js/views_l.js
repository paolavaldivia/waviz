...
dpt.currval = coeff.signal[g.currMouseDate + coeff.n * g.clickedI]
  ...
  dpt.signalWidth =  document.getElementById('vsignal').offsetWidth - dpt.margin.left - dpt.margin.right -5;
  ...
  coeff.intervals.forEach(function(d, i) {
   currentsignal.push({date: d, value: coeff.signal[i + coeff.n * g.clickedI]}) ;
 });
